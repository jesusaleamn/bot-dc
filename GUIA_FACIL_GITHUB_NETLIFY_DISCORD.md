...
```text
bot-inventarios-discord
```

No añadas README desde GitHub si te lo pregunta.

Después, en PowerShell:

```powershell
git add .
git commit -m "Bot de inventarios para Discord en Netlify"
git branch -M main
git remote add origin https://github.com/TU_USUARIO/bot-inventarios-discord.git
git push -u origin main
```

Si `git remote add origin` dice que ya existe:

```powershell
git remote set-url origin https://github.com/TU_USUARIO/bot-inventarios-discord.git
git push -u origin main
```
